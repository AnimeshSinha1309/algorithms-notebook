...
\begin{titlepage}
    ...
    \includegraphics[scale=0.3]{logo.png}\\[0.5cm]
    ...
    \HRule \\[0.4cm]
    { \huge \bfseries Algorithms Notes}\\[0.4cm]
    \HRule \\[1.5cm]
    \begin{minipage}{0.6\textwidth}
        \begin{flushleft} \large
            \emph{Maintainers:} Animesh Sinha, Gaurang Tandon, Dixit Garg, Arpan Dasgupta.
        \end{flushleft}
    \end{minipage}\\[2cm]
    {\large \today}\\[2cm]
    \vfill
...
\input{_strategysheet.tex}
\input{probability.tex}
\input{stackqueueheap.tex}
\input{rangequeries.tex}
\input{dynamicprogramming.tex}
\input{gametheory.tex}
\input{mathematicaltools.tex}
\input{graphstrees.tex}
\input{flows.tex}
